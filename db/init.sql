...
VALUES (10.5, 20.3, 30.2, 'Red', 'Entry1', 'Credit Card', 'Paid', 5, '2024-05-16', 'Contact', TRUE, 'OLX', 'orzel1n', 'Detailed long description', 350);

INSERT INTO mask_order (size_x, size_y, size_z, color, entry, payment, payment_status, discount, date_of_order, status, payment_received, source_of_order, nickname, description, price) 
VALUES (15.5, 25.3, 35.2, 'Blue', 'Entry2', 'PayPal', 'Pending', 10, '2024-05-17', 'Contact', FALSE, 'OLX', 'dzesica21', 'Detailed long description 2', 335);
